<div class="sidebar-tabs">
		        ...
		        <div id="general">
			        ...
			        <div class="sidebar-user widget">
						<div class="navbar"><div class="navbar-inner"><h6>Wazzup, <?php echo $_SESSION['username']?></h6></div></div>
			            <a href="#" title="" class="user"><img src="<?php echo base_url() ?>template/img/demo/sidebar_user_big.png" alt="" /></a>
			            <ul class="user-links">
			        ...
			        <ul class="navigation widget">
			            <li class="active"><a href="index-2.html" title=""><i class="icon-home"></i>Dashboard</a></li>
		        ...
		        <div id="stuff">
				    ...
				    <div class="widget">
				    	...
				    	<div class="row-fluid thumbs">
					    	<div class="span6">
					    		<a href="img/demo/big.jpg" class="lightbox"><img src="<?php echo base_url() ?>template/img/demo/media/1.png" alt="" /></a>
					    		<a href="img/demo/big.jpg" class="lightbox"><img src="<?php echo base_url() ?>template/img/demo/media/2.png" alt="" /></a>
					    		<a href="img/demo/big.jpg" class="lightbox"><img src="<?php echo base_url() ?>template/img/demo/media/3.png" alt="" /></a>
					    		<a href="img/demo/big.jpg" class="lightbox"><img src="<?php echo base_url() ?>template/img/demo/media/4.png" alt="" /></a>
					    	</div>
					    	<div class="span6">
					    		<a href="img/demo/big.jpg" class="lightbox"><img src="<?php echo base_url() ?>template/img/demo/media/5.png" alt="" /></a>
					    		<a href="img/demo/big.jpg" class="lightbox"><img src="<?php echo base_url() ?>template/img/demo/media/6.png" alt="" /></a>
					    		<a href="img/demo/big.jpg" class="lightbox"><img src="<?php echo base_url() ?>template/img/demo/media/7.png" alt="" /></a>
					    		<a href="img/demo/big.jpg" class="lightbox"><img src="<?php echo base_url() ?>template/img/demo/media/8.png" alt="" /></a>
					    	</div>
					    </div>
				    </div>
				    <!-- /gallery thumbs -->
